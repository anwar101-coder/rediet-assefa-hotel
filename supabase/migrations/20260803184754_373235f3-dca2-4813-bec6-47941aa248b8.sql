...
DROP POLICY "Staff can insert rooms" ON public.rooms;
DROP POLICY "Staff can update rooms" ON public.rooms;
DROP POLICY "Staff can delete rooms" ON public.rooms;
